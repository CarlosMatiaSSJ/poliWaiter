    ...
    margin-left: 30px;"> <a
                ...
                <div class="relative overflow-x-auto">
                    ...
                    <form class="d-flex float-right mr-3 mt-3" role="search">
                        <input name="filtrar" value="{{ $filtrar }}" type="search" placeholder="Filtrar"
                            id="small-input"
                            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <button class="btn btn-primary" type="submit"></button>
                    </form>
                    <a href="{{ route('alimento.export') }}" type="button"
                        class="w-25 p-3 ml-3 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 mt-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Exportar
                        PDF</a>
